  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-24 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <span className="inline-flex items-center gap-2 text-xs px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary">
            <span className="w-1.5 h-1.5 rounded-full bg-primary" /> 99.9% uptime guaranteed
          </span>
          ...
          <h1 className="mt-6 text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight">
            ...
            like
            <br />
            <span className="text-gradient-green">never before</span>
          </h1>

          <p className="mt-6 max-w-xl text-muted-foreground">
            Over <span className="text-foreground font-medium">20,000+ live channels</span>,{" "}
            <span className="text-foreground font-medium">180,000+ movies & series</span> in Full
            HD, 4K and UHD — compatible with all your devices.
          </p>

          <div className="mt-8 flex flex-wrap gap-3">
            <button className="px-5 py-3 rounded-full bg-gradient-primary text-primary-foreground font-medium shadow-glow hover:opacity-90 transition">
              Start Free Trial
            </button>
            <button className="px-5 py-3 rounded-full border border-border bg-surface/60 text-foreground hover:bg-surface transition">
              See Plans & Pricing
            </button>
          </div>
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/5 p-5 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <div className="text-sm text-muted-foreground">
              Your subscription is about to expire and you need to extend?{" "}
              <span className="text-foreground">Click the Extend Subscription button.</span>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-6 mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          { v: "20,000+", l: "Live Channels" },
          { v: "180,000+", l: "Movies & Series" },
          { v: "99.9%", l: "Uptime" },
          { v: "6+", l: "Years Experience & Trust" },
        ].map((s) => (
